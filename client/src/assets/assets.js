...
import banner from './b3_banner.png'
...
export const students = [
  {
    ...
    projects: [
      { title: "MediCare AI", description: "AI-powered symptom checker with 92% accuracy using NLP and patient history analysis." },
      { title: "FarmConnect", description: "IoT-based crop monitoring system for farmers with real-time soil health alerts." },
      { title: "CodeCollab", description: "Real-time collaborative code editor with video calling (like Google Docs for devs)." },
      { title: "BudgetBuddy", description: "Personal finance tracker with ML-based spending predictions and savings tips." }
    ],
    social: {
  ...
  },
  {
    ...
    projects: [
      { title: "AgriBot", description: "Autonomous weed-killing robot for farms using computer vision and precision spraying." },
      { title: "SmartCane", description: "IoT-enabled cane for visually impaired with obstacle detection and GPS navigation." },
      { title: "DroneDelivery", description: "Medical supply delivery drone with collision avoidance for rural areas." },
      { title: "GestureControl", description: "Wristband that controls home appliances with hand gestures (no voice needed)." }
    ],
    social: {
  ...
  },
  {
    ...
    projects: [
      { title: "SecureVote", description: "Blockchain-based voting system with biometric authentication and tamper-proof records." },
      { title: "PhishShield", description: "Browser extension that detects phishing sites using ML and community reports." },
      { title: "CryptoGuard", description: "Hardware wallet for cryptocurrencies with self-destruct mechanism on tampering." },
      { title: "DarkWebScan", description: "Tool to check if your credentials are leaked on dark web markets." }
    ],
    social: {
  ...
  },
  {
    ...
    projects: [
      { title: "AutoScale", description: "Cost-optimized auto-scaling system for cloud workloads using predictive algorithms." },
      { title: "ServerlessAI", description: "ML model deployment framework that scales to zero when inactive." },
      { title: "KubeGuard", description: "Security auditing tool for Kubernetes clusters with real-time vulnerability scanning." },
      { title: "CloudCost", description: "Dashboard to track and optimize AWS/GCP spending across teams." }
    ],
    social: {
  ...
  },
  {
    ...
    projects: [
      { title: "Accessify", description: "Chrome extension that auto-fixes accessibility issues on websites in real-time." },
      { title: "MoodBoard", description: "AI-assisted design tool that suggests color palettes based on emotions." },
      { title: "EduPlay", description: "Gamified learning app for kids with ADHD-friendly interactive elements." },
      { title: "TypeCraft", description: "Variable font generator that adjusts based on reader's reading speed." }
    ],
    social: {
  ...
  },
  {
    ...
    projects: [
      { title: "FakeNewsDetect", description: "Chrome extension that flags potentially fake news using NLP analysis." },
      { title: "SignTranslator", description: "Real-time sign language to speech conversion using pose estimation." },
      { title: "RecipeGen", description: "AI that generates recipes based on fridge ingredients and dietary needs." },
      { title: "JobMatch", description: "Resume optimizer that A/B tests versions for higher interview rates." }
    ],
    social: {
  ...
  },
  {
    ...
    projects: [
      { title: "ARHistory", description: "Museum AR app that brings historical artifacts to life with animations." },
      { title: "PuzzleCraft", description: "Procedurally generated 3D puzzle game with infinite difficulty levels." },
      { title: "VirtualDance", description: "Motion-capture app that teaches dance via real-time avatar feedback." },
      { title: "EcoSim", description: "Educational game about climate change with realistic ecosystem modeling." }
    ],
    social: {
  ...
  },
  {
    ...
    projects: [
      { title: "FastAPI", description: "High-performance API gateway for microservices with 10ms latency." },
      { title: "ChainSafe", description: "Cross-blockchain bridge for transferring NFTs between Ethereum and Solana." },
      { title: "DataPipe", description: "Real-time data pipeline processing 1M events/sec with Go and Kafka." },
      { title: "WasmEdge", description: "WebAssembly runtime for edge devices with Rust-based security." }
    ],
    social: {
  ...
  },
  {
    ...
    projects: [
      { title: "QEncrypt", description: "Post-quantum encryption protocol resistant to Shor's algorithm attacks." },
      { title: "ChemSim", description: "Quantum chemistry simulator for molecular modeling on IBM QPUs." },
      { title: "OptiRoute", description: "Quantum-inspired algorithm for logistics route optimization." },
      { title: "QMLib", description: "Open-source library for quantum machine learning implementations." }
    ],
    social: {
