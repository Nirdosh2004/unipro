...
const CallToAction = () => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className='mx-4 my-10 sm:mx-10 flex flex-col sm:flex-row bg-gradient-to-br from-emerald-100 to-emerald-200 shadow-xl border border-green-200 rounded-3xl overflow-hidden'
    >
      {/* Hero Left Side */}
        ...
        <div className='text-gray-800'>
          ...
          >
            <div className='flex items-center bg-white/50 px-3 py-1.5 rounded-full shadow-sm'>
              ...
              Trusted by Developer (allegedly, Shri Nirdosh Kushwaha).
            </div>
            <div className='flex items-center bg-white/50 px-3 py-1.5 rounded-full shadow-sm'>
              <svg className='w-4 h-4 mr-2 text-green-500' fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
      ...
      >
        <div className='absolute inset-0 bg-gradient-to-l from-emerald-100/50 to-transparent z-10 sm:hidden'></div>
        <div className='absolute inset-0 bg-gradient-to-t from-emerald-50/20 to-transparent z-10 hidden sm:block'></div>
        <img
