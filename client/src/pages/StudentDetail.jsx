    ...
    return (
      <div className="max-w-4xl mx-auto py-8 text-center min-h-screen flex items-center justify-center px-4">
        ...
        >
          ...
          <p className="text-gray-600 mb-6">No student found with enrollment number: <span className="font-mono bg-gray-100 px-2 py-1 rounded">{enrollmentNo}</span></p>
        ...
        <div className="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              >
                {student.bio || 'Passionate developer with expertise in modern web technologies and problem-solving.'}
              </motion.p>
            </motion.div>
              ...
              <div className="space-y-4">
                {student.social?.github && (
                  ...
                  >
                    ...
                    <a href={student.social.github} target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-green-600">
                      GitHub Profile
                    </a>
                  </motion.div>
                )}
                ...
                {student.social?.linkedin && (
                  ...
                  >
                    ...
                    <a href={student.social.linkedin} target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-green-600">
                      LinkedIn Profile
                    </a>
                  </motion.div>
                )}
                ...
                {student.social?.portfolio && (
                  ...
                  >
                    ...
                    <a href={student.social.portfolio} target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-green-600">
                      Personal Portfolio
                    </a>
                  </motion.div>
                )}
